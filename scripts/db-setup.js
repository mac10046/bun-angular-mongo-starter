 ...
 *
 * Usage:
 *   bun scripts/db-setup.js
 *   bun scripts/db-setup.js --with-admin
 *   bun scripts/db-setup.js --with-admin --admin-email=admin@example.com --admin-password=YourPassword123
 */
...
async function main() {
  ...
  1. Run with --with-admin to create an admin user:
     ${colors.cyan}bun scripts/db-setup.js --with-admin${colors.reset}
